...
filenames, models = readModels('caras')
...
for key, frame in autoStream():
    ...
    for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
        ...
        #print(match)
        #cojo el trozo a ocultar y le aplico un filtro que emborrone la cara
        trozo = frame[top:bottom, left:right]

        frame[top:bottom, left:right] = cv.medianBlur(trozo,31)
